...
pub fn derive_form_model(input: TokenStream) -> TokenStream {
    ...
    let impl_ast = quote! {
        impl #impl_generics ::form::form_model::FormModel for #struct_name #ty_generics #where_clause {
        }

        impl #impl_generics ::form::form_model::FormValue for #struct_name #ty_generics #where_clause {
            ...
            fn value(&self, field_path: &str) -> String {
                let (field_name, suffix) = ::form::form_model::split_field_path(field_path);
